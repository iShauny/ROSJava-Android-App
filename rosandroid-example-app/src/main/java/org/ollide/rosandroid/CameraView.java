        ...
        public void onStart(ConnectedNode connectedNode) {
            ...
            Joystick.setOnMoveListener(new JoystickView.OnMoveListener() {
                ...
                public void onMove(int angle, int strength) {
                    // convert angle into wheel movements and strength as a multiplier between
                    // 0 and 1
                    ...
                    /* To better understand the next algorithm, here is an explanation:
                       ...
                       Visualise a circle on an x and z axis with a max radius equal to when
                       strength is 100%.
                       ...
                       far right counter-clockwise. Additionally, we use multipliers to apply
